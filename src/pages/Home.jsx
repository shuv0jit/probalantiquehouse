...
useReveal([shown.length, savedOnly, loading, sort, collectionId]);
  ...
  useEffect(() => {
   ...
   const setSort = (id) => {
  const next = new URLSearchParams(params);
  if (sort === id) next.delete('sort'); // toggle off, falls back to 'newest'
          ...
          {!collectionId && !savedOnly && (
            <section className="hero anim-up">
              ...
              <h1 className="display">
                Designs you love, <em>memories</em>, that shine.
              </h1>
              <p>
                Explore our newest jewelry designs! If any piece catches your eye, just drop us a picture or the item code on Messenger or WhatsApp. We’ll instantly help you with prices, details, and easy ordering. Jewelry for your best moments, made to last.
              </p>
